...
public class PlayView4 extends JFrame {
	...
	public PlayView4() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(PlayView4.class.getResource("/icon/tic-tac-toe.png")));
		...
		tictactoe.setLayout(new GridLayout(N, N,8,5));
		...
		btnStart.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (cl.equals("0")) {
					...
					for (int i = 0; i < N; i++) {
						for (int j = 0; j < N; j++) {
							if (BTXO[i][j].cell.getValue().equals("O")) BTXO[i][j].setIcon(new ImageIcon("image/o2_60x60.jpg"));
							else if (BTXO[i][j].cell.getValue().equals("X")) BTXO[i][j].setIcon(new ImageIcon("image/x2_60x60.jpg"));
							else BTXO[i][j].setIcon(new ImageIcon("image/border_60x60.jpg"));
						}
					}
					...
					for (int i = 0; i < N; i++) {
						for (int j = 0; j < N; j++) {
							BTXO[i][j].setIcon(new ImageIcon("image/border2_60x60.jpg"));
						}
					}
		...
		lblOffline.setBounds(124, 69, 83, 28);
		...
		for (int i = 0; i < N; i++)
			for (int j = 0; j < N; j++) {
				...
				BTXO[i][j] = bt;
				BTXO[i][j].setIcon(new ImageIcon("image/border_60x60.jpg"));
				BTXO[i][j].addMouseListener(new MouseListener() {
					...
					public void mouseExited(MouseEvent e) {
						// TODO Auto-generated method stub
						if (BTXO[x][y].cell.isVisited()==false && ST==0) BTXO[x][y].setIcon(new ImageIcon("image/border_60x60.jpg"));				
						if (BTXO[x][y].cell.isVisited()==false && ST==1) BTXO[x][y].setIcon(new ImageIcon("image/border_60x60.jpg"));		
					}
					...
					public void mouseEntered(MouseEvent e) {
						...
						if (BTXO[x][y].cell.isVisited()==false && ST==1 && PlayerCR == player1) BTXO[x][y].setIcon(new ImageIcon("image/o2_pre_60x60.jpg"));
						if (BTXO[x][y].cell.isVisited()==false && ST==1 && PlayerCR == player2) BTXO[x][y].setIcon(new ImageIcon("image/x2_pre_60x60.jpg"));
					}
						...
						if (ST == 1) {
							...
							if (bt.cell.isVisited() == false) {
								if (PlayerCR == player1) {
									playSound();
									clicked++;
									bt.setIcon(new ImageIcon("image/o2_60x60.jpg"));
									bt.cell.setValue("O");
									...
									playSound();
									clicked++;
									bt.setIcon(new ImageIcon("image/x2_60x60.jpg"));
									bt.cell.setValue("X");
									bt.cell.setVisited(true);
				...
				if (count == 4) {
					for (int k = col; k > col - 4; k--) {
						if (PlayerCR.getValue().equals("X"))
							BTXO[i][k].setIcon(new ImageIcon("image/xwin_60x60.jpg"));
						if (PlayerCR.getValue().equals("O"))
							BTXO[i][k].setIcon(new ImageIcon("image/owin_60x60.jpg"));
					}
					choose();
			...
			if (cell.cell.getValue().equals(PlayerCR.getValue())) {
				...
				if (count == 4) {
					for (int k = row; k > row - 4; k--) {
						if (PlayerCR.getValue().equals("X"))
							BTXO[k][j].setIcon(new ImageIcon("image/xwin_60x60.jpg"));
						if (PlayerCR.getValue().equals("O"))
							BTXO[k][j].setIcon(new ImageIcon("image/owin_60x60.jpg"));
					}
					choose();
				}
			} else {
			...
			if (cell.cell.getValue().equals(PlayerCR.getValue())) {
				...
				if (count == 4) {
					...
					for (; x > TopI - 4 && TopJ - 4 < y; x--, y--) {
						if (PlayerCR.getValue().equals("X"))
							BTXO[x][y].setIcon(new ImageIcon("image/xwin_60x60.jpg"));
						if (PlayerCR.getValue().equals("O"))
							BTXO[x][y].setIcon(new ImageIcon("image/owin_60x60.jpg"));
					}
					choose();
				}
			} else {

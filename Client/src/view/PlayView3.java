...
public class PlayView3 extends JFrame {
	...
	public PlayView3() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(PlayView3.class.getResource("/icon/tic-tac-toe.png")));
		...
		lblNewLabel_6.setFont(new Font("Courier New", Font.ITALIC, 20));
		...
		lblNewLabel_8.setBounds(90, 331, 83, 13);
		...
		lblChoivsMay.setBounds(68, 119, 165, 28);

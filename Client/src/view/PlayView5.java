...
public class PlayView5 extends JFrame {
	...
	public PlayView5() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(PlayView5.class.getResource("/icon/tic-tac-toe.png")));
		...
		tictactoe.setLayout(new GridLayout(N, N, 8, 6));
		...
		lblNewLabel_5.setFont(new Font("Courier New", Font.BOLD | Font.ITALIC, 20));
		...
		lblNewLabel_6.setBounds(13, 448, 242, 42);
		...
		btnStart.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (cl.equals("0")) {
					...
					for (int i = 0; i < N; i++) {
						for (int j = 0; j < N; j++) {
							if (BTXO[i][j].cell.getValue().equals("O")) BTXO[i][j].setIcon(new ImageIcon(OnePlayerView.class.getResource("/icon/o2.jpg")));
							else if (BTXO[i][j].cell.getValue().equals("X")) BTXO[i][j].setIcon(new ImageIcon(OnePlayerView.class.getResource("/icon/x2.jpg")));
							else BTXO[i][j].setIcon(new ImageIcon("image/border.jpg"));
						}
					}
					...
					for (int i = 0; i < N; i++) {
						for (int j = 0; j < N; j++) {
							BTXO[i][j].setIcon(new ImageIcon("image/border2.jpg"));
						}
					}
		...
		lblNewLabel_8.setFont(new Font("Courier New", Font.ITALIC, 15));
		lblNewLabel_8.setBounds(90, 329, 83, 13);
		...
		lblgameCaro.setFont(new Font("Courier New", Font.BOLD | Font.ITALIC, 25));
		...
		lblChoivsMay.setBounds(68, 115, 165, 28);
			...
			for (int j = 0; j < N; j++) {
				...
				BTXO[i][j].addMouseListener(new MouseListener() {
					...
					public void mouseExited(MouseEvent e) {
						// TODO Auto-generated method stub
						if (BTXO[x][y].cell.isVisited()==false && ST==0) BTXO[x][y].setIcon(new ImageIcon("image/border.jpg"));				
						if (BTXO[x][y].cell.isVisited()==false && ST==1) BTXO[x][y].setIcon(new ImageIcon("image/border.jpg"));		
					}

					@Override
					public void mouseEntered(MouseEvent e) {
						// TODO Auto-generated method stub
						if (BTXO[x][y].cell.isVisited()==false && ST==0) BTXO[x][y].setIcon(new ImageIcon("image/border2.jpg"));
						if (BTXO[x][y].cell.isVisited()==false && ST==1 && PlayerCR == player1) BTXO[x][y].setIcon(new ImageIcon(OnePlayerView.class.getResource("/icon/o2_pre.jpg")));
						if (BTXO[x][y].cell.isVisited()==false && ST==1 && PlayerCR == player2) BTXO[x][y].setIcon(new ImageIcon(OnePlayerView.class.getResource("/icon/x2_pre.jpg")));
					}
				...
				if (count == 5) {
					for (int k = col; k > col - 5; k--) {
						if (PlayerCR.getValue().equals("X"))
							BTXO[i][k].setIcon(new ImageIcon(OnePlayerView.class.getResource("/icon/xwin.jpg")));
						if (PlayerCR.getValue().equals("O"))
							BTXO[i][k].setIcon(new ImageIcon(OnePlayerView.class.getResource("/icon/owin.jpg")));
					}
					choose();
